 ...
 * 
 * <p>
 * The Transform menu contains actions such as resize, rotate, and flip that
...
public class TransformActions {
    ...
    public TransformActions() {
        ...
        actions.add(new ResizeAction(LanguageSettings.getTranslated("resize"),
                new ImageIcon("src/images/resize_small.png"), LanguageSettings.getTranslated("resizeDesc"), null));
        actions.add(new ImageRotationAction(LanguageSettings.getTranslated("rotateLeft"),
                new ImageIcon("src/images/rotate-left_small.png"), LanguageSettings.getTranslated("rotateLeftDesc"),
                Integer.valueOf(KeyEvent.VK_E)));
        actions.add(new ImageRotationAction(LanguageSettings.getTranslated("rotateRight"),
                new ImageIcon("src/images/rotate-right_small.png"), LanguageSettings.getTranslated("rotateRightDesc"),
                Integer.valueOf(KeyEvent.VK_R), 1));
        actions.add(new FlipAction(LanguageSettings.getTranslated("flipVertical"),
                new ImageIcon("src/images/flip-v_small.png"), LanguageSettings.getTranslated("flipVerticalDesc"), KeyEvent.VK_V,
                Flip.FLIP_VERTICAL));
        actions.add(new FlipAction(LanguageSettings.getTranslated("flipHorizontal"),
                new ImageIcon("src/images/flip-h_small.png"), LanguageSettings.getTranslated("flipHorizontalDesc"),
                KeyEvent.VK_H));
        actions.add(new CropAction(LanguageSettings.getTranslated("crop"), new ImageIcon("src/images/crop_small.png"),
                LanguageSettings.getTranslated("cropDesc"), null));
        actions.add(new DrawAction(LanguageSettings.getTranslated("draw"), new ImageIcon("src/images/draw_small.png"),
                LanguageSettings.getTranslated("drawDesc"), null));
    ...
    public class FlipAction extends ImageAction {
        ...
        FlipAction(String name, ImageIcon icon, String desc, Integer mnemonic) {
            ...
            this.direction = Flip.FLIP_HORIZONTAL;
            // Set the hotkey 'ctrl + shift + v' to trigger a flipHorizontal action.
            KeyStroke o = KeyStroke.getKeyStroke(KeyEvent.VK_H, Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx() | KeyEvent.VK_SHIFT, enabled);
        ...
        FlipAction(String name, ImageIcon icon, String desc, Integer mnemonic, int direction) {
            ...
            // Set the hotkey 'ctrl + shift + v' to trigger a flipHorizontal action.
            KeyStroke o = KeyStroke.getKeyStroke(KeyEvent.VK_V, Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx()| KeyEvent.VK_SHIFT, enabled);
            putValue(Action.ACCELERATOR_KEY, o);
    ...
    public class ResizeAction extends ImageAction {
        ...
        ResizeAction(String name, ImageIcon icon, String desc, Integer mnemonic) {
            super(name, icon, desc, mnemonic);
            // Set the hotkey 'ctrl + shift + r' to trigger a file-resize action.
            KeyStroke o = KeyStroke.getKeyStroke(KeyEvent.VK_R,
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                int option = JOptionPane.showOptionDialog(target.getParent(), myPanel,
                        LanguageSettings.getTranslated("resize"),
                        JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, resizeIcon,
                        new String[] { LanguageSettings.getTranslated("ok"), LanguageSettings.getTranslated("cancel") },
                        null);
                if (option == JOptionPane.OK_OPTION) {
                    update(scaleSpinner.getNumber().doubleValue() / 100, widthSpinner.getNumber().intValue(),
                            heightSpinner.getNumber().intValue());
    ...
    public class ImageRotationAction extends ImageAction {
        ...
        ImageRotationAction(String name, ImageIcon iconName, String desc, Integer mnemonic, int rotation) {
            ...
            KeyStroke r = KeyStroke.getKeyStroke(KeyEvent.VK_R, Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx(),
                    enabled);
        ...
        ImageRotationAction(String name, ImageIcon iconName, String desc, Integer mnemonic) {
            super(name, iconName, desc, mnemonic);
            this.rotation = 2;

            // Sets 'ctrl + l' as the hotkey triggering an image-rotation action (left)
            KeyStroke r = KeyStroke.getKeyStroke(KeyEvent.VK_E, Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx(),
                    enabled);
            putValue(Action.ACCELERATOR_KEY, r);
    ...
    public class CropAction extends ImageAction {
        ...
        CropAction(String name, ImageIcon icon, String desc, Integer mnemonic) {
            ...
            KeyStroke c = KeyStroke.getKeyStroke(KeyEvent.VK_C,
                    Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx() | InputEvent.SHIFT_DOWN_MASK, enabled);
    ...
    public class DrawAction extends ImageAction {
        ...
        DrawAction(String name, ImageIcon icon, String desc, Integer mnemonic) {
            ...
            // Add an empty border with desired spacing between the colorChooser and
            // thicknessPanel
            ...
            KeyStroke c = KeyStroke.getKeyStroke(KeyEvent.VK_D,
                    Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx() | InputEvent.SHIFT_DOWN_MASK, enabled);
            putValue(Action.ACCELERATOR_KEY, c);
            InputMap inputMap = target.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW);
            inputMap.put(c, getValue(Action.NAME));
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                Object[] drawOptions = { LanguageSettings.getTranslated("rect"), LanguageSettings.getTranslated("oval"),
                        LanguageSettings.getTranslated("line") };
                int selectedOption = JOptionPane.showOptionDialog(null, optionsPanel,
                        LanguageSettings.getTranslated("drawShape"),
