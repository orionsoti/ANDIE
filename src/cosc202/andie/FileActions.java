...
public class FileActions {
    ...
    public FileActions() {
        ...
        actions.add(
                new FileOpenAction(LanguageSettings.getTranslated("open"), new ImageIcon("src/images/open_small.png"),
                        LanguageSettings.getTranslated("openDesc"), Integer.valueOf(KeyEvent.VK_O)));
        actions.add(
                new FileSaveAction(LanguageSettings.getTranslated("save"), new ImageIcon("src/images/save_small.png"),
                        LanguageSettings.getTranslated("saveDesc"), Integer.valueOf(KeyEvent.VK_S)));
        actions.add(new FileSaveAsAction(LanguageSettings.getTranslated("saveAs"),
                new ImageIcon("src/images/save-as_small.png"), LanguageSettings.getTranslated("saveAsDesc"),
                Integer.valueOf(KeyEvent.VK_A)));
        actions.add(new FileExportAction(LanguageSettings.getTranslated("export"),
                new ImageIcon("src/images/export_small.png"), LanguageSettings.getTranslated("exportDesc"),
                Integer.valueOf(KeyEvent.VK_E)));
        actions.add(new FileLanguage(LanguageSettings.getTranslated("language"),
                new ImageIcon("src/images/language_small.png"), LanguageSettings.getTranslated("languageDesc"),
                Integer.valueOf(0)));
        actions.add(
                new FileExitAction(LanguageSettings.getTranslated("exit"), new ImageIcon("src/images/exit_small.png"),
                        LanguageSettings.getTranslated("exitDesc"), Integer.valueOf(0)));
    ...
    public class FileLanguage extends AbstractAction {
        ...
        FileLanguage(String name, ImageIcon icon, String desc, Integer mnemonic) {
            ...
            KeyStroke o = KeyStroke.getKeyStroke(KeyEvent.VK_L,
        ...
        public void actionPerformed(ActionEvent e) {
            /**
             * <p>
             * Action to open popup for language selection with a combo box displaying all
             * options.
             * </p>
             */
            ...
            int option = JOptionPane.showOptionDialog(null, langPanel, LanguageSettings.getTranslated("language"),
    ...
    public class FileOpenAction extends ImageAction {
        ...
        FileOpenAction(String name, ImageIcon icon, String desc, Integer mnemonic) {
            ...
            KeyStroke o = KeyStroke.getKeyStroke(KeyEvent.VK_O, Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx(),
                    enabled);
            putValue(Action.ACCELERATOR_KEY, o);
         ...
         * If this image is larger than our limit of 2160x3840 the applications will
         * inform the user.
         * </p>
         * 
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    try {
                        ...
                        if (sizeChecker.getHeight() > 2160 || sizeChecker.getWidth() > 3840) {
                            ...
                            JOptionPane.showOptionDialog(null, LanguageSettings.getTranslated("tooLarge"),
                        ...
                        Object[] options = { LanguageSettings.getTranslated("ok") };
                        JOptionPane.showOptionDialog(null, LanguageSettings.getTranslated("incompatible"),
                                LanguageSettings.getTranslated("alert"),
                                JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]);

                    }
                } else if (result == JFileChooser.CANCEL_OPTION) { // File menu wouldn't close if an image that was too
                                                                   // large was chosen, added this to counter-act
                    flag = false;
                    break;
                }
            } while (flag == true);
    ...
    public class FileSaveAction extends ImageAction {
        ...
        FileSaveAction(String name, ImageIcon icon, String desc, Integer mnemonic) {
            ...
            KeyStroke s = KeyStroke.getKeyStroke(KeyEvent.VK_S, Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx(),
                    enabled);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                Object[] options = { LanguageSettings.getTranslated("ok") };
                JOptionPane.showOptionDialog(null, LanguageSettings.getTranslated("unsaved"),
                        LanguageSettings.getTranslated("alert"),
                        JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options, options[0]);
    ...
    public class FileSaveAsAction extends ImageAction {
        ...
        FileSaveAsAction(String name, ImageIcon icon, String desc, Integer mnemonic) {
            ...
            KeyStroke sA = KeyStroke.getKeyStroke(KeyEvent.VK_S,
    ...
    public class FileExportAction extends ImageAction {
        ...
        FileExportAction(String name, ImageIcon icon, String desc, Integer mnemonic) {
            ...
            KeyStroke eX = KeyStroke.getKeyStroke(KeyEvent.VK_E,
                    Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx() | InputEvent.SHIFT_DOWN_MASK, enabled);
