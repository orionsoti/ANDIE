...
public class AcidFilter implements ImageOperation, java.io.Serializable {
     ...
     * 
     * @param startLoc chooses a number between 0 and 2 and will start randomizing
     *                 at that location (e.g red = 0, green = 1, blue = 2).
     * @param rand     passes a value up to 255 to change color channel choosen by
     *                 startLoc.
     */
     ...
     * @param rand     passes a value up to 255 to change color channel choosen by
     *                 startLoc.
     * @param rand2    passes second value up to 255 will be on whatever color
     *                 chanel that is below the first.
     */
     ...
     * @param rand2    passes second value up to 255 will be on whatever color
     *                 chanel that is below the first.
     * @param rand3    passes third value up to 255 will be on whatever color chanel
     *                 that is below the second.
     */
     ...
     * 
     * <p>
     * Splits the colours into RGB and then applys a radomized color change on each
     * depending which has been choosen
     * </p>
     * 
